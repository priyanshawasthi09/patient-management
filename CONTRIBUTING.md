...
<h3 align="center">Welcome to the patient-management project! 😍<br>
We appreciate your interest in contributing.😊<br> </h3>

First off, thank you for considering contributing to **patient-management!** We're excited to have you join our community. Every contribution, no matter how small, helps us build the best academic resource platform for students.
...
By contributing to this project, you agree that your contributions will be licensed under the [`License`](https://github.com/priyanshawasthi09/patient-management/blob/main/LICENSE)
...
Your contributions earn points that count toward GSSoC'25 and your patient-management Leaderboard status!
...
- Take a look at the existing [**Issues**](https://github.com/priyanshawasthi09/patient-management/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/priyanshawasthi09/patient-management/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
...
This **CONTRIBUTING.md** was prepared with **❤️** by  [`DIVYA JAIN`](https://github.com/DivyaJain-DataAnalyst) for **patient-management** as part of the **GSSoC'25 program.**
...
<h3 align="center">
Thank you for contributing to patient-management 🌟
 <br>
